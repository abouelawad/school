...
<html>
 ...
 <head>
<meta charset="utf-8">
<title>Akadimia HTML Template | Login</title>
<!-- Stylesheets -->
    	...
    	<div class="auto-container">
        	...
        	<div class="inner-container">
				...
				<div class="styled-form">
					<form method="post" action="https://demo.auburnforest.com/html/akadimia/akadimia/index.html">
						...
						<div class="form-group text-center">
							<button type="button" class="theme-btn btn-style-one"><span class="txt">Instructor Sign Up Now</span></button>
						</div>
